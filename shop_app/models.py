...
class Product(models.Model):
    ...
    def __str__(self):
        return f'Product: {self.name_product},  quantity: {self.quantity}, cost: {self.cost},  description: {self.description_product}, product creation date: {self.date_add_product}'
